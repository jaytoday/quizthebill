...
function award_sliderInit()
{

        var $panels = $('#award_container #awards > div');
        var $container = $('#award_container #awards');
        ...
        var $scroll = $('#award_container #award_scroll').css('overflow', 'hidden');
...
*/
        ...
        var scrollOptions = 
        {
                ...
                prev: 'button#award_prev', 
                next: 'button#award_next',
        ...
        $('#award_container').serialScroll(scrollOptions);
